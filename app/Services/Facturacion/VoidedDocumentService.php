...
{
    public function send(array $data, \App\Models\Empresa $company): array
    {
        ...
        $gre=app(\App\Services\Sunat\GreenterService::class); $xml=$gre->getXml($doc,$company); app(\App\Services\Sunat\XmlService::class)->save($xml,$doc->getName().'.xml'); $result=$gre->send($doc,$company);
