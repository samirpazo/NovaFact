...
return [
    ...
    */
    ...
    'uploaded' => 'Sube :attribute fallida.',
    ...
    */
    ...
    'attributes' => [
        ...
        'motivoTraslado' => 'motivo de traslado',
        'modalidadTraslado' => 'modalidad de traslado',
        'pesoTotal' => 'peso total',
        'unidadMedida' => 'unidad de medida',
        'remitente' => 'remitente',
        'remitente.ruc' => 'RUC del remitente',
        'remitente.razonSocial' => 'razón social del remitente',
        'destinatario' => 'destinatario',
        'destinatario.tipoDoc' => 'tipo de documento del destinatario',
        'destinatario.numDoc' => 'número de documento del destinatario',
        'destinatario.razonSocial' => 'razón social del destinatario',
        'ubigeoPartida' => 'ubigeo de partida',
        'direccionPartida' => 'dirección de partida',
        'ubigeoLlegada' => 'ubigeo de llegada',
        'direccionLlegada' => 'dirección de llegada',
    ],
